...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = component.register('fxos-media-controls', {
	  created: function() {
	    ...
	    // Detect the start of a long-press
	    ...
	    // Detect the end of a long-press
	  ...
	  attrs: {
	    paused: {
	      ...
	      set(value) {
	        ...
	        // Trigger style change to prevent jumpy transition when switching
	        // between 'play' and 'pause'.
	        this.els.toggle.classList.toggle('paused', paused);
	      }
	    }
	  },
	...
	<style>
	  ...
	  #container {
	    background: var(--fxos-background-minus-minus);
	    border-top: 1px solid var(--fxos-background);
	    direction: ltr;
	    display: flex;
	  ...
	  #container > button:active {
	    background: var(--fxos-button-background);
	  ...
	  /**
	   * Prevent jumpy transition when toggling play/pause
	   */
	  #container > button.paused:before {
	    padding-left: 4px;
	  }
	</style>`
	});
